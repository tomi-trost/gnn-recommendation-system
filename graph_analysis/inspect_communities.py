...
# Rebuild item names from raw data 
item_names: dict = {}
...
# Filter projection and run Louvain (same params as notebook) 
...
# Print top-15 items per community by weighted degree 
